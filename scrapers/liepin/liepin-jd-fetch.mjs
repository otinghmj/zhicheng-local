...
const API_PORT = Number(process.env.SCRAPER_API_PORT || process.env.BOSS_API_PORT || 3337);
const API_KEY  = String(process.env.BOSS_API_KEY  || "").trim();
const CDP_URL  = String(process.env.SCRAPER_CDP_URL || process.env.BOSS_CDP_URL  || "http://127.0.0.1:9223").trim();
